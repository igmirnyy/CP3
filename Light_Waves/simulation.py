...
#         }light = taichi.Struct.field( # Struct for saving states of light (RGB) in each pixel
#             {
...
#             shape=model.shape
#         )
# kappa = taichi.Vector.field(3, dtype=taichi.f32, shape=model.shape) # 3d array of refraction coefficients
        
# light.from_numpy(impulse_array_dict)
# # light_start.from_numpy(impulse_array_dict)
# kappa.from_numpy(model.kappa)
       

# image = taichi.Vector.field(3, dtype=taichi.f32, shape=model.shape) # 3d array for 
...
# def accumulate( ) -> None:
#     """
#     Accumulate the light movement over time
...
#     """
#     Simulation step with accumulation
#     """
#     open_boundary()
#     propagate()
#     accumulate()
